            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {{ Form::text('name', '', array('class' => 'form-control', 'placeholder' => 'Customer Name')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {{ Form::email('email', '', array('class' => 'form-control', 'placeholder' => 'Customer Email')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {{ Form::text('attn_name', '', array('class' => 'form-control', 'placeholder' => 'Attn Name')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {{ Form::text('address_line_1', '', array('class' => 'form-control', 'placeholder' => 'Address-1')) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {{ Form::text('address_line_2', '', array('class' => 'form-control', 'placeholder' => 'Address-2')) }}
                        </div>
                    </div>
